  ...
  <div class="az-header">
    <div class="container">
      <div class="az-header-left">
        <a href="index.php" class="standard-logo az-logo" data-dark-logo="images/logo-dark.png"><img src="images/logo.png" alt="Datefix Logo"></a>
        <a href="index.php" id="azNavShow" class="standard-logo az-header-menu-icon d-lg-none" data-dark-logo="images/logo-dark.png"><img src="images/logo.png" alt="Datefix Logo"></a>
        <a href="" id="azChatBodyHide" class="az-header-arrow"><i class="icon ion-md-arrow-back"></i></a>
      </div><!-- az-header-left -->
      <div class="az-header-center">
        <input type="search" class="form-control" placeholder="Search for messages or contacts...">
